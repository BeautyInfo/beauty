$(function() {
	var url = "https://beauty.nttu.biz/beautyUniversity/v1/school/university/analytic/false";
	...
	$("#go-school-btn").click(function(event) {
		...
		if($("#fans-page-name").text() === "表特大學") {
			...
			url = "https://beauty.nttu.biz/beautyUniversity/v1/school/FJU/analytic/false";
		}
		else {
			$("#go-school-btn").text("表特輔仁");
			$("#fans-page-name").text("表特大學");
			url = "https://beauty.nttu.biz/beautyUniversity/v1/school/university/analytic/false";
		}
		jsonGet(url);
	});
	...
	$("#highchart-btn").click(function(event) {
		...
		if($("#fans-page-name").text() === "表特輔仁") {
			url = "https://beauty.nttu.biz/beautyUniversity/v1/school/FJU/analytic/true";
		}
		
		if($("#fans-page-name").text() === "表特大學") {
			url = "https://beauty.nttu.biz/beautyUniversity/v1/school/university/analytic/true";
		}
